...
<img src="./showcase/date_ranges.gif" alt="date_ranges" width="60%"/>

### Interval Notes
Can link 2 notes together to create an interval.

<img src="./showcase/interval_notes.gif" alt="interval_notes" width="60%"/>

### Multiple Timelines
Can manage up to 5 timelines at a time.

<img src="./showcase/multiple_timelines.gif" alt="multiple_timelines" width="60%"/>
